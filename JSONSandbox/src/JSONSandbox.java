...
public class JSONSandbox {
    public static void main(String[] args) {
        ...
        try {
            String jsonString = "{\"name\":\"Peanut Butter and Jelly\",\"description\":\"Classic, always good.\"}";
            HashMap aMap = (HashMap) JSONUtilities.parse(jsonString); 
            String aName = (String) aMap.get("name");  
            String aDescription = (String) aMap.get("description"); 

            recipeBean parsedRecipe = new recipeBean();
            parsedRecipe.setName(aName);
            parsedRecipe.setDescription(aDescription);

            String parsedRecipeJSONString = JSONUtilities.stringify(parsedRecipe);
            System.out.println(parsedRecipeJSONString);
